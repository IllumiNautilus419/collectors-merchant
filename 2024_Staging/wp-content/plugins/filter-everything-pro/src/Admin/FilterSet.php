    ...
    private function setupDefaultFields()
    {
        ...
        $defaultFields = array(
            ...
            'wp_filter_query' => array(
                ...
                'options'       => '',
                'default'       => '-1',
                'instructions'  => esc_html__('Determines what exactly Posts list (WP_Query) on a page should be filtered', 'filter-everything'),
                'settings'      => true
            ),
            'hide_empty' => array(
                'type'          => 'Select',
            ...
            'show_count' => array(
                ...
                'default'       => 'yes',
                'instructions'  => esc_html__('Displays number of posts in a term', 'filter-everything'),
                'settings'      => true
            )
